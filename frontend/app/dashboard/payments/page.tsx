    ...
    <div className="max-w-7xl space-y-10 p-6">
      ...
      {loading ? (
        ...
        <div className="group relative">
          <div className="absolute -inset-1 bg-linear-to-r from-blue-600 to-cyan-500 rounded-[2.5rem] blur opacity-20 group-hover:opacity-30 transition duration-500"></div>
